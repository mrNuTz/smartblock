...
exports.selectLastBlock = exports.getUniqId = exports.getBrowser = exports.getHtmlFromNode = exports.stripPtag = exports.isDescendant = exports.calculateStyle = exports.createTable = exports.liftListItem = exports.setNodeMarkup = exports.findSelectedNodeWithType = exports.getParentNodePosFromState = exports.getParentNodeFromState = exports.getParentNodeIndexFromState = exports.getParentNodeWithPosFromState = exports.getRootNodeCountFromState = exports.getRootNodeWithPosByIndex = exports.findNodePosition = exports.canInsert = exports.blockActive = exports.getMarkInSelection = exports.markActive = exports.getViewport = exports.isInput = exports.getOffset = exports.getScrollLeft = exports.getScrollTop = void 0;
...
exports.getMarkInSelection = function (markName, state) {
    var _a = state.selection, from = _a.from, to = _a.to, $from = _a.$from, empty = _a.empty;
    if (empty)
        return (state.storedMarks || $from.marks()).find(function (mark) { return (mark.type.name === markName); });
    var res = null;
    state.doc.nodesBetween(from, to, function (node) {
        res = res || node.marks.find(function (mark) { return (mark.type.name === markName); });
    });
    return res;
};
...
function setNodeMarkup(nodeType, attrs) {
    return function (state, dispatch) {
        ...
        if (!applicable)
            return false;
        if (dispatch)
            dispatch(state.tr.setNodeMarkup(_pos, nodeType, attrs).scrollIntoView());
        return true;
    };
}
exports.setNodeMarkup = setNodeMarkup;
...
exports.selectLastBlock = function (containerId) {
    var root = document.getElementById(containerId);
    var p = root.querySelector('.ProseMirror > p:last-child');
    if (!p)
        return;
