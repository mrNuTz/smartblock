...
var getPlugins = function (extensions, schema) {
    ...
    extensions.forEach(function (extension) {
        if (extension.plugins) {
            customPlugins = __spreadArrays(customPlugins, extension.plugins);
        }
    });
    var keyPlugin = getKeys(extensions, schema);
    return __spreadArrays(customPlugins, [keyPlugin]);
};
...
var PluginToolbarContainer = React.memo(function () { return React.createElement("div", { className: "plugin-toolbar-container" }); });
exports.default = (function (props) {
    ...
    var _b = useState(false), showMenus = _b[0], setShowMenus = _b[1];
    ...
    return (React.createElement("div", { id: containerId, onClick: function (e) {
        ...
        React.createElement("div", { className: classnames_1.default('smartblock-container', { 'is-full': props.full }), onClick: function (e) {
                var target = e.target;
                if (target.classList.contains('smartblock-container'))
                    utils_1.selectLastBlock(containerId);
            } },
            props.showTitle &&
            ...
            React.createElement("div", { className: "smartblock-inner" },
                React.createElement("div", { className: showMenus ? '' : 'ProseMirrorHideSelection', ref: container },
                    React.createElement("div", { className: "smartblock-input-area" }, options && React.createElement(editor_1.default, { options: options, nodeViews: nodeViews, onChange: function (state, dispatch) {
                            ...
                            var inlineMenu = getMenu(marks);
                            return (React.createElement(React.Fragment, null,
                                React.createElement("div", { className: "smartblock-menus-container", style: { display: showMenus ? null : 'none' } },
                                    React.createElement(menu_1.default, { view: view, menu: getMenu(blocks), inlineMenu: inlineMenu }),
                                    React.createElement(edit_menu_1.default, { view: view, menu: getMenu(edits) }),
                                    shouldRenderInlineMenu(view, blocks) &&
                                        React.createElement(inline_menu_1.default, { menu: inlineMenu, blockMenu: getMenu(blocks), view: view }),
                                    ...
                                    React.createElement(PluginToolbarContainer, null)),
                                editor));
                        } })))))));
});
