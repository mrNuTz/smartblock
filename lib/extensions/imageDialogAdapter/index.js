...
var image_plus_icon_1 = require("../image/image-plus-icon");
var ImageDialogAdapter = /** @class */ (function (_super) {
    __extends(ImageDialogAdapter, _super);
    function ImageDialogAdapter(_a) {
        var openDialog = _a.openDialog, attributes = _a.attributes, props = __rest(_a, ["openDialog", "attributes"]);
            ...
            return {
                ...
                parseDOM: [{
                        ...
                        getAttrs: function (dom) {
                            var attrs = _this._attributes.reduce(function (attrs, attr) {
                                attrs[attr] = dom.getAttribute(attr);
                                return attrs;
                            }, {});
                            return __assign(__assign({}, attrs), { src: dom.querySelector('img').getAttribute('src') });
                        }
                    }],
                toDOM: function (node) {
                    var _a = node.attrs, src = _a.src, attrs = __rest(_a, ["src"]);
                    return ['figure', attrs, ['img', { src: src }], ['figcaption', { class: 'caption' }, 0],];
                }
            };
        },
        enumerable: false,
