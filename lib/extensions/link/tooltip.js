...
var TooltipComponent = function (props) {
    ...
    return (React.createElement("div", { className: "smartblock-tooltip-wrap", ref: container, style: style },
        ...
        editing === 'true' &&
            React.createElement(tooltip_react_1.default, { url: url, onClick: function (href) {
                    ...
                    tr.addMark(beforePos, afterPos, view.state.schema.marks.link.create({ href: href, editing: '' }));
                    view.dispatch(tr);
                } })));
};
