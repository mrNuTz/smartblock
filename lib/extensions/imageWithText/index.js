...
var ImageWithText = /** @class */ (function (_super) {
    ...
    function ImageWithText(_a) {
        var openDialog = _a.openDialog, attributes = _a.attributes, previewSrcFromAttrs = _a.previewSrcFromAttrs, props = __rest(_a, ["openDialog", "attributes", "previewSrcFromAttrs"]);
        ...
        get: function () {
            ...
            return {
                ...
                toDOM: function (node) {
                    ...
                    return ['section', {}, ['figure', { class: 'img-float-left' }, ['img', __assign(__assign({}, attrs), { src: src, _src: _src })]], ['main', {}, 0],];
                }
            };
        },
        enumerable: false,
    ...
    ImageWithText.prototype.customMenu = function (_a) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(button_1.default, { onClick: function () { return _this.openDialog(state, dispatch); } },
                React.createElement(image_icon_1.default, { style: { width: '24px', height: '24px' } }))));
    };
