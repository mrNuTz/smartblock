...
var Heading = /** @class */ (function (_super) {
    ...
    Heading.prototype.customMenu = function (_a) {
        ...
        var tag = node ? sizeToTag[node.attrs.hsize] : 'h';
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(button_1.default, { type: "button", active: node && node.attrs.usehtag, title: "use " + tag + "-tag", onClick: function () {
