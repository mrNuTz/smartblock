...
var full_icon_1 = require("../image/full-icon");
...
var Table = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Table.prototype, "schema", {
        get: function () {
            ...
            schemas.table.parseDOM = [{
                    tag: 'table',
                    getAttrs: function (dom) { return ({ wide: dom.classList.contains('wide') }); }
                }];
            schemas.table.toDOM = function (node) {
                return [
                    'table',
                    {
                        class: (_this.className || '') + (node.attrs.wide ? ' wide' : '')
                    },
                    ['tbody', 0]
                ];
            };
    ...
    Table.prototype.customMenu = function (_a) {
        var state = _a.state, dispatch = _a.dispatch;
        var node = utils_1.findSelectedNodeWithType(state.schema.nodes.table, state);
        if (!node)
            return null;
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(button_1.default, { type: "button", title: "wide format", onClick: function () {
                    return utils_1.setNodeMarkup(node.type, __assign(__assign({}, node.attrs), { wide: !node.attrs.wide }))(state, dispatch);
                } },
                React.createElement(full_icon_1.default, { style: {
