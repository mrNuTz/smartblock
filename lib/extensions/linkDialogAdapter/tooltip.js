...
var TooltipComponent = function (props) {
    ...
    var onOk = function (link) {
        var tr = view.state.tr;
        tr.removeMark(beforePos, afterPos, view.state.schema.marks.link);
        tr.addMark(beforePos, afterPos, view.state.schema.marks.link.create(__assign(__assign({}, link), { editing: false })));
        view.dispatch(tr);
    };
    ...
    return (React.createElement("div", { className: "smartblock-tooltip-wrap", ref: container, style: style },
        ...
        editing &&
            React.createElement(tooltip_react_1.default, { onDel: function () {
                    var tr = view.state.tr;
                    tr.removeMark(beforePos, afterPos, view.state.schema.marks.link);
                    view.dispatch(tr);
                }, onEdit: function () { return openDialog(onOk, onCancel); } })));
};
