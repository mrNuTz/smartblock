    ...
    Object.defineProperty(Cta.prototype, "schema", {
        get: function () {
            ...
            return {
                ...
                parseDOM: [
                    {
                        ...
                        getAttrs: function (dom) {
                            ...
                            return !a ? {} : _this._attributes.concat('_class').reduce(function (attrs, attr) {
                                if (attr === 'class')
                                    return attrs;
                                var val = a.getAttribute(attr);
                                if (val)
                                    attrs[attr === '_class' ? 'class' : attr] = val;
                                return attrs;
                            }, {});
                        },
                ...
                toDOM: function (node) {
                    var _a = node.attrs, _class = _a.class, attrs = __rest(_a, ["class"]);
                    return ['div', { class: 'cta' }, ['a', __assign(__assign({ role: 'button' }, attrs), { _class: _class, class: (_class || '') + " variant-" + (node.attrs.variant || 'primary') }), node.attrs.text || '']];
                }
            };
        },
        enumerable: false,
