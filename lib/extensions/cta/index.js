    ...
    Object.defineProperty(Cta.prototype, "schema", {
        get: function () {
            ...
            return {
                ...
                toDOM: function (node) {
                    return ['div', { class: 'cta' }, ['a', __assign(__assign({ role: 'button' }, node.attrs), { class: (node.attrs.class || '') + " " + (node.attrs.variant ? 'variant-' + node.attrs.variant : '') }), ['span', { class: 'text' }, node.attrs.text || '']],
                    ];
                }
            };
        },
