...
var Image = /** @class */ (function (_super) {
    ...
    function Image(_a) {
        var _b = _a.imgClassName, imgClassName = _b === void 0 ? 'small' : _b, _c = _a.imgFullClassName, imgFullClassName = _c === void 0 ? 'full' : _c, _d = _a.captionClassName, captionClassName = _d === void 0 ? 'caption' : _d, _e = _a.withCaption, withCaption = _e === void 0 ? true : _e, _f = _a.onChange, onChange = _f === void 0 ? function (preview) { return Promise.resolve(preview); } : _f;
        var _this = _super.call(this, {}) || this;
        _this.imgClassName = imgClassName;
        _this.imgFullClassName = imgFullClassName;
        _this.captionClassName = captionClassName;
        _this.withCaption = withCaption;
    ...
    Image.prototype.customMenu = function (_a) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(button_1.default, { type: "button", style: {
                    ...
                    prosemirror_commands_1.setBlockType(state.schema.nodes.image, attr)(state, dispatch);
                } },
